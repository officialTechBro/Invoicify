...
const Header = () => {
    ...
    const user = {name: 'Taiwo', email: 'taiwo@techbroofficial.com'}
  ...
  return (
    ...
    >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-7">
            <div className="flex items-center justify-between h-16 lg:h-29">
                ...
                <div className="hidden lg:flex items-center space-x-4">
                    {isAuthenticated ? (
                        ...
                        />
                            ...
                            <Link to="/login" className="text-black hover:text-gray-900 font-mediun transition-colors duration-200">Login</Link>
                            <Link to="/signup" className="bg-linear-to-r from-blue-950 to-blue-900 hover:bg-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg">Signup</Link>
                        </>
                    }
                </div>
